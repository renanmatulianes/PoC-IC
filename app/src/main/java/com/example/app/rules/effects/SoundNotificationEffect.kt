// NOVO ARQUIVO: SoundNotificationEffect.kt
...
/**
 * Aciona a notificação sonora.
 */
class SoundNotificationEffect : Effect {
    override fun apply(context: NotificationContext, ui: NotificationUI) {
        val notif = context.psmBsmNotification?.driver_data ?: return

        // Converte os dados do contexto para os enums que o SoundManager espera
